export const APP_NAME = "Cookbook App";
export const RECIPES = "Recepty";
export const INGREDIENTS = "Ingredience";
...
export const FOOTER_TEXT_CREATED_YEAR = "2024";
export const FOOTER_TEXT_MESSAGE = "Tato webová aplikace byla vytvořena v rámci Unicorn React školení";
